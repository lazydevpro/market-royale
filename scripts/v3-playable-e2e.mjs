...
const reportPath = file("deployments/v3-playable-e2e.json");
const report = fs.existsSync(reportPath)
  ? read("deployments/v3-playable-e2e.json")
  : {
      version: 3,
      chainId: 50312,
...
const pendingPath = file(".testnet/v3-runner-pending.json");
const save = () =>
