// Deploys the V4 arena and its Shannon-only progression sidecar. Every signed
...
const reportPath = file("deployments/shannon-v4.json");
const pendingPath = file(".testnet/v4-deploy-pending.json");
const report = fs.existsSync(reportPath)
  ? read("deployments/shannon-v4.json")
  : {
      chainId: 50312,
      version: 4,
      host: host.address,
...
await deploy("Deploy V4 arena", "arena", arenaArtifact, [
  TOKEN,
  MODULE,
  CREATOR,
  VENUE,
