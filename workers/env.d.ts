/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/wrangler.jsonc --env-interface=KeeperEnv workers/env.d.ts` (hash: 7affe59daf88da354679ff299ee17c0f)
// Runtime types generated with workerd@1.20260903.1 2026-09-04 nodejs_compat
interface __BaseEnv_KeeperEnv {
	LIQUIDITY_SPONSOR: "0x24a43ad7e9318cf515867477bf9c489989dcc701";
	ROYALE_ADDRESS: "0x4a17dc5e798e68060e6e8cadbf795531557880cd";
	PROGRESSION_ADDRESS: "0xaecf844569aba92494947bc4edf8e268c31b5c54";
	OFFICIAL_HOST: "0x8143FFD10c8fb63ce18E5672077f0Df1b9a33259";
	DAILY_GAS_BUDGET_STT: "10";
	GAS_FAUCET_ADDRESS: "0x751586985D47f49D0745991758ac2426E2f2d0a7";
	GAS_GRANT_STT: "1";
	FAUCET_DAILY_GRANTS: "50";
	BOT_BACKFILL: "1";
	BOT_ADDRESSES: "0x8FA9A665Df9933CE11Be8f1769b66180a55d41a0,0x6C3162695B106F9F200057113bE7C60469C4A399,0x32840FF1c9fCDF3862D420B9FB5927Ce24e92Cbd,0xF5339652Db213CC08091d8C6e973640cae8e526b";
	BOT_JOIN_LEAD_SECONDS: "300";
	BOT_TARGET_PLAYERS: "4";
	KEEPER_PRIVATE_KEY: string;
	GAS_FAUCET_PRIVATE_KEY: string;
	FAUCET_API_TOKEN: string;
	BOT_PRIVATE_KEYS: string;
	EVENT_KEEPER: DurableObjectNamespace<import("./keeper").EventKeeper>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./keeper");
		durableNamespaces: "EventKeeper";
	}
	interface Env extends __BaseEnv_KeeperEnv {}
}
interface KeeperEnv extends __BaseEnv_KeeperEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LIQUIDITY_SPONSOR" | "ROYALE_ADDRESS" | "PROGRESSION_ADDRESS" | "OFFICIAL_HOST" | "DAILY_GAS_BUDGET_STT" | "GAS_FAUCET_ADDRESS" | "GAS_GRANT_STT" | "FAUCET_DAILY_GRANTS" | "BOT_BACKFILL" | "BOT_ADDRESSES" | "BOT_JOIN_LEAD_SECONDS" | "BOT_TARGET_PLAYERS" | "KEEPER_PRIVATE_KEY" | "GAS_FAUCET_PRIVATE_KEY" | "FAUCET_API_TOKEN" | "BOT_PRIVATE_KEYS">> {}
}
